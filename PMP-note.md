...
- [附二 十大模型](#附二-十大模型)
  - [1-规范的项目管理过程](#1-规范的项目管理过程)
  - [2-主要的相关方](#2-主要的相关方)
  - [3-PMO的工作内容](#3-PMO的工作内容)
  - [4-启动和收尾流程](#4-启动和收尾流程)
  - [5-项目规划流程](#5-项目规划流程)
  - [6-项目执行监控流程](#6-项目执行监控流程)
  - [7-项目变更管理](#7-项目变更管理)
  - [8-质量管理流程](#8-质量管理流程)
  - [9-风险管理流程](#9-风险管理流程)
  - [10-挣值管理](#10-挣值管理)
...
监控：Monitor & Control 监督控制

【考点】  
`根本原因分析（RAC Root Cause Analysis）`：识别问题的主要原因  
`偏差分析`：目标绩效与实际绩效之间的偏差  
`趋势分析`：根据以往结果预测未来绩效

【考点】输入：工作绩效信息；输出：工作绩效报告  
大图：所有执行及监控过程  
各种信息汇总成报告
...
![变更管理流程](./images/4.6-change_control.png)
...
【考点】配置管理：侧重技术指标或参数；变更管理：侧重改变过程  

【考点】改东西->变更管理计划；不知怎么进行->相关管理计划  

【考点】虚实逻辑  

- 虚：遇到某某情况该如何处理，遵循变更控制程序
- 实：执行具体工作

【考点】已发生的是问题；未发生的是风险；有问题先解决，需要改变东西是变更
...
![项目收尾顺序](./images/4.7-close_project.png)

合同收尾顺序：

![合同收尾顺序](./images/4.7-close_contract.png)
...
![规范的项目管理过程](./images/appendix-1.png)

### 2-主要的相关方

![主要的相关方](./images/appendix-2.png)

### 3-PMO的工作内容

![PMO的工作内容](./images/appendix-3.png)

### 4-启动和收尾流程

启动顺序：  
先有工作说明书，然后进行商业论证，然后编写章程，发起人授权项目经理

收尾顺序：

项目收尾

![项目收尾](./images/4.7-close_project.png)

合同收尾

![合同收尾](./images/4.7-close_contract.png)

### 5-项目规划流程

![项目规划流程](./images/appendix-5.png)

### 6-项目执行监控流程

![项目执行监控流程](./images/appendix-6.png)

### 7-项目变更管理

![项目变更管理](./images/4.6-change_control.png)

### 8-质量管理流程

![质量管理流程](./images/appendix-8.png)

### 9-风险管理流程

![风险管理流程](./images/11-manage_risk.png)
