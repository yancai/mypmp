...
【考点】工具的使用场景：专家判断（不靠谱，没数据找专家）、数据收集（访谈、头脑风暴（发散产生创意）、焦点小组（组织专家专项讨论））、人际关系与团队技能（冲突管理、引导（达成共识）、会议管理）、会议、名义小组（为头脑风暴投票排序）、德尔菲Delphi（匿名投票）

顺序：先有工作说明书，然后进行商业论证，然后编写章程，发起人授权项目经理
